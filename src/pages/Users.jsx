...
const Users = () => {
  ...
  const customNames = ["Ghyalpo", "Paru", "Tenzin", "Dolma", "Sonam", "Pasang"];
      ...
      axios.get('https://reqres.in/api/users?per_page=12')
        .then(res => {
          const enhancedUsers = res.data.data.map((user, index) => ({
            ...
            role: index % 2 === 0 ? "Lead Developer" : "Product Designer",
            status: "Active",
            joined: "Jan 2026"
          }));
        ...
        {filteredUsers.map(user => (
          <div key={user.id} className="user-card-pro">
            ...
            <div className="user-details-mini">
              ...
              <div className="detail-item"><span>Joined:</span> {user.joined}</div>
            </div>
